    ...
    <div class="border-b border-gray-900/10 pb-12">
      ...
      <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        ...
        <div class="sm:col-span-3">
          ...
          <div class="mt-2">
            <select id="type" name="type" autocomplete="type-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
              @foreach (App\Enums\TalkType::case() as $talkType)
                <option {{ old('type') === $talkType->value ? 'selected' : '' }}">{{ ucwords($talkType->value) }}</option>
        ...
        <div class="col-span-full">
          ...
          <div class="mt-2">
            <input type="text" name="length" id="length" autocomplete="length" value = "{{ old('length') }}"class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            <!-- test 123$6/891011121314-->
          </div>
        </div>
